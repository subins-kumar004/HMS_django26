...
const Sidebar = () => {
  ...
  if (role.includes('admin')) {
    ...
    navLinks.push({ path: '/receptionist/patients', label: 'Patients (Reception)', icon: <Users size={20} /> });
    navLinks.push({ path: '/receptionist/appointments', label: 'Appointments (Reception)', icon: <Calendar size={20} /> });
    navLinks.push({ path: '/doctor/consultations', label: 'Consultations (Doctor)', icon: <Activity size={20} /> });
    navLinks.push({ path: '/doctor/prescriptions', label: 'Prescriptions (Doctor)', icon: <Pill size={20} /> });
    navLinks.push({ path: '/pharmacist/medicines', label: 'Medicines (Pharmacy)', icon: <Pill size={20} /> });
    navLinks.push({ path: '/pharmacist/inventory', label: 'Inventory (Pharmacy)', icon: <Activity size={20} /> });
    navLinks.push({ path: '/labtech/tests', label: 'Lab Tests (Lab)', icon: <FlaskConical size={20} /> });
    navLinks.push({ path: '/labtech/results', label: 'Test Results (Lab)', icon: <Activity size={20} /> });
