...
// Generic Dashboard Stub
const GenericDashboard = ({ moduleName }) => {
  return (
    <div className="glass-panel" style={{ padding: '30px', textAlign: 'center' }}>
      <h2 style={{ fontSize: '28px', color: 'var(--accent-primary)', marginBottom: '10px' }}>{moduleName} Portal</h2>
      <p style={{ color: 'var(--text-secondary)' }}>
        Welcome to the {moduleName} module. Use the sidebar to manage your records.
      </p>
    </div>
  );
};
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route element={<Layout allowedRoles={['receptionist']} title="Receptionist Dashboard" />}>
            <Route path="/receptionist" element={<GenericDashboard moduleName="Receptionist" />} />
          ...
          <Route element={<Layout allowedRoles={['doctor']} title="Doctor Dashboard" />}>
            <Route path="/doctor" element={<GenericDashboard moduleName="Doctor" />} />
          ...
          <Route element={<Layout allowedRoles={['pharmacist']} title="Pharmacist Dashboard" />}>
            <Route path="/pharmacist" element={<GenericDashboard moduleName="Pharmacist" />} />
          ...
          <Route element={<Layout allowedRoles={['lab']} title="Lab Technician Dashboard" />}>
            <Route path="/labtech" element={<GenericDashboard moduleName="Lab Technician" />} />
